...
# Create summary tables and plots for simulation studies using URSS

# load simulation results
# normal
load("./urss.normal.result.Rdata")
# lognormal
#load("./urss.lognormal.result.Rdata")
# uniform
#load("./urss.uniform.result.Rdata")
...
# save as csv files
# normal
#write.csv(retable,"./urss.res.normal.csv")
# lognormal
#write.csv(retable,"./urss.res.lognormal.csv")
# uniform
#write.csv(retable,"./urss.res.uniform.csv")
